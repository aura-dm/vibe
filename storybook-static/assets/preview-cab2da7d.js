import "./es.object.get-own-property-descriptor-3c6dc3cf.js";
import { r as i } from "./index-032912bc.js";
import { j as c, a as h } from "./jsx-runtime-9ef5153c.js";
import {
  F as b,
  W as f,
  C as r,
} from "./styled-components.browser.esm-7eff8319.js";

var d = Object.defineProperty;
var t = (e, o) => d(e, "name", { value: o, configurable: !0 });
import {
  C as r,
  W as f,
  F as b,
...
const u = {
    ...
    &.error {
      ...
      color: ${({ theme: e }) => e.colors.error.c500};
      fill: ${({ theme: e }) => e.colors.error.c500};
    }
    ...
    &.success {
      ...
      color: ${({ theme: e }) => e.colors.success.c500};
      fill: ${({ theme: e }) => e.colors.success.c400};
    }

    &.warning {
      border: 1px solid ${({ theme: e }) => e.colors.warning.c100};
      color: ${({ theme: e }) => e.colors.warning.c500};
      fill: ${({ theme: e }) => e.colors.warning.c400};
    }
  `,
    icon: r`
    align-items: center;
  ...
  g = {
    ...
    &:hover {
      background-color: ${({ theme: e }) => e.colors.neutral.c100};
    }
    ...
    &.secondary {
      border: 1px solid ${({ theme: e }) => e.colors.neutral.c500};
      ...
      &:focus-visible {
        box-shadow: 0 0 0 2px ${({ theme: e }) => e.colors.neutral.c200};
        outline: none;
      }

      &:disabled {
        border: 1px solid ${({ theme: e }) => e.colors.neutral.c300};
        color: ${({ theme: e }) => e.colors.text.c100};
      }
    }
  `,
  ...
  `,
    panel: r`
    background-color: ${({ theme: e }) => e.colors.neutral.c50};
  ...
  w = {
    base: r`
    align-items: center;
    border-bottom: 1px solid ${({ theme: e }) => e.colors.neutral.c200};
    display: flex;
  ...
  n = {
    ...
    textAlt: {
      c50: "rgba(255, 255, 255, 0.25)",
      c100: "rgba(255, 255, 255, 0.4)",
      c200: "rgba(255, 255, 255, 0.55)",
      c300: "rgba(255, 255, 255, 0.7)",
      c400: "rgba(255, 255, 255, 0.85)",
      c500: "rgba(255, 255, 255, 1)",
    },
    error: { c400: "#b82020", c500: "#961616" },
    success: { c400: "#58920c", c500: "#47760a" },
    warning: { c400: "#b87816", c500: "#a06813" },
  ...
  v = {
    ...
    h5: ["1.25rem", "1.3"],
    small: ["0.8rem", "1.75"],
    subtitle: ["0.64rem", "1.75"],
  },
  z = { normal: 400, medium: 600, bold: 700 },
  _ = {
    input: { focus: `box-shadow: 0 0 0 2px ${n.neutral.c200};` },
    modal: {
...
`,
  p = { modals: [] },
  V = i.createContext({ dispatch: () => null, state: p }),
  E = t((e, o) => {
    switch (o.type) {
      case "addModal":
        return { modals: [...e.modals, o.payload] };
      case "removeModal":
        return { modals: e.modals.filter((a) => a.id !== o.payload.id) };
      default:
        throw new Error();
    }
  }, "mainReducer"),
  s = t(({ children: e }) => {
    const [o, a] = i.useReducer(E, p);
    return c(V.Provider, { value: { state: o, dispatch: a }, children: e });
  }, "AppProvider");
try {
  (s.displayName = "AppProvider"),
    (s.__docgenInfo = {
      description: "",
    ...
    typeof STORYBOOK_REACT_CLASSES < "u" &&
      (STORYBOOK_REACT_CLASSES[
        "src/components/VApp/stores/AppStore/AppProvider.tsx#AppProvider"
      ] = {
        docgenInfo: s.__docgenInfo,
        name: "AppProvider",
        path: "src/components/VApp/stores/AppStore/AppProvider.tsx#AppProvider",
      });
} catch {}
const m = t(
  ({ children: e, theme: o = l }) =>
    c(b, { theme: o, children: h(s, { children: [c(T, {}), e] }) }),
  "VApp"
);
try {
  (m.displayName = "VApp"),
    ...
    typeof STORYBOOK_REACT_CLASSES < "u" &&
      (STORYBOOK_REACT_CLASSES["src/components/VApp/VApp.tsx#VApp"] = {
        docgenInfo: m.__docgenInfo,
        name: "VApp",
        path: "src/components/VApp/VApp.tsx#VApp",
      });
} catch {}
const C = t(
    (e) => c(m, { portalId: "portal", theme: l, children: c(e, {}) }),
    "withThemeProvider"
  ),
  W = {
  ...
  j = [C];
export { j as decorators, W as parameters };
